class ScenePromotion extends Phaser.Scene {
  ...
  create() {
    ...
    let boutonOui = creerBouton(this, false, 220, 480, 'DÉNONCER VOS COLLABORATEURS');
    let boutonNon = creerBouton(this, false, 600, 480, 'DÉMISSIONNER');
